...
<?php  
  global $sectionn;
                          $sql3 = "SELECT * FROM proposal_summary WHERE Section_No= $sectionn" ; 
                          if($result3 = mysqli_query($connect, $sql3)){
							   if(mysqli_num_rows($result3)>0){
                              while($row4 = mysqli_fetch_array($result3)){
								  $summ = $row4['summay_text'];
                                  $sup_rev = $row4['supervisor_rev'];
								  $coor_rev = $row4['coor_review'];
...
<tr><th colspan="10">GP1 Proposal Summary1 (minimum 100 words)</th></tr>
  <tr><td colspan="8" class = "texta">  <textarea name="proposal_summary" placeholder="minimum 100 words"><?php echo $summ;  ?></textarea></td></tr>

<tr><th colspan="10">Supervisor Review:</th></tr>
<tr><td colspan="10" class="sup_rev"><?php echo $sup_rev;  ?><td></tr>

<tr><th colspan="10">Coordinaitor Review:</th></tr>
<tr><td colspan="10" class="sup_rev"><?php echo $coor_rev;  ?><td></tr>
 </table></div><br> 
<?php  
                               $sql3 = "SELECT * FROM proposal_summary WHERE Section_No= $sectionn" ; 
                          if($result3 = mysqli_query($connect, $sql3)){
							  ...
							  if($row4['status'] == 'student'){
?>

<input class="form-submit-button" id="but" type="submit" value="Submit" name="doneP" />
<?php  
							  }
							  else {
