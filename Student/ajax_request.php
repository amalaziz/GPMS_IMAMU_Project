            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="deliverables.html" class="nav__link active">
						...
						<!-- For coordinatior and supervisor -->
						<!--
...
<!--<p class="para1"><strong>GPMS</strong></p>-->
  ...
  <input  class="input-field" id="searchProject" type="text" placeholder="Search.." name="search">
 </div>
</form>
                         ...
                         if($result2 = mysqli_query($connect, $sql2))
{
                         if(mysqli_num_rows($result2)>0){
							 ...
							 while ($row2 = mysqli_fetch_array($result2)){
							  ...
							  echo ' <div class="category category_color3"></div>';}
							  else {
								echo ' <div class="category category_color2"></div>';  
							  }
					         ...
					         if($result = mysqli_query($connect, $sql))
{
		...
		while ($row = mysqli_fetch_array($result)){
			...
			echo '>';
			echo $row['First_name'].' '.$row['Middle_name1'].' '.$row['Last_name'];	
			echo '</option>';	
		}
		echo '</select>';
	}
...
echo ' <div class="activity"><strong>Section:</strong>';	 
		...
		echo '<br>'.'<strong>Course:</strong>'.' '.$row2['coruse_NO'].'<br>'.'<strong>Project title:</strong>'.'<table><tr><th class ="leftSide">Examiner 1</th><th class ="rightSide">Examiner 2</th></tr>';
					         ...
					         if($result3 = mysqli_query($connect, $sql3))
{
		...
		while ($row3 = mysqli_fetch_array($result3)){
			echo '<option value='.$row3['First_name'].' ';
...
if($result4 = mysqli_query($connect, $sql4))
{
    if(mysqli_num_rows($result4)>0){
		...
		while ($row4 = mysqli_fetch_array($result4)){
			echo '<option value='.$row4['First_name'].' ';
