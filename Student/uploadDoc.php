...
<title>Final Submissions</title>
		<link href="cssdoc/bootstrap.css" rel="stylesheet" type="text/css" media="screen">
        <link rel="stylesheet" type="text/css" href="cssdoc/DT_bootstrap.css">
...
.tabcontent {  padding: 12px 6px;}
	...
	<script src="jsdoc/jquery.js" type="text/javascript"></script>
	<script src="jsdoc/bootstrap.js" type="text/javascript"></script>
	
	<script type="text/javascript" charset="utf-8" language="javascript" src="jsdoc/jquery.dataTables.js"></script>
	<script type="text/javascript" charset="utf-8" language="javascript" src="jsdoc/DT_bootstrap.js"></script>
	   <body id="body-pd">
...
<?php
 $query=$dbh->query("select * from assments order by id desc");
 ...
 ?> <tr>
				...
				<td>
					<button class="alert-success"><a href="viewDoc.php?id=<?php echo $row['id'] ?>">Download</a></button>
