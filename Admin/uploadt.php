...
//IS-GP2-F18-Report-1443-Spring
 $text1 = 'IS-'.$GP.'-F'.$gro.'-Report-2022-Spring.docx';
 $text2 = 'IS-'.$GP.'-F'.$gro.'-Presentation-'.$year.'-'.$ses.'.pptx';
 ...
 $stmt=$dbh->prepare("insert into finalproject (name, mime, data) values(?,?,?)");
...
$stmt->execute(); 
 ...
 //edit delivarbles page section unkonwn
 //timestamp calling
 //cv name of user return name of username or what 
 //info more than extension 
 // file pdf how to defind as pdf 
...
<?php
 ...
 ?> <tr>
        ...
        <th class="alert-success"><a href="deletefile.php?id=<?php echo $row['id']; ?>" class="text-white"> Delete </a>  </button> </td></th>
           ...
           <tr>
               <td>archive files</td>
               <td rowspan="2"><button ><a href="archive.php">Archive</a></button></td>
