...
echo '<textarea name="sub_rev">'.$row3['supervisor_rev'].'</textarea>';
...
?>
     ...
     <?php  
							  ...
							  if($row3['status'] == 'supervisor'){
?>
<input type="submit" name="Accept_fm" value="Accept" class = "button1" title = "Submit to Coordinatior">
<input type="submit" name="Reject_fm" value="Reject" class = "button2" title = "Resubmit to student">
<?php  
							  }
