...
$sql2="SELECT * FROM progress_report WHERE section_number= $id";
		...
		<th>Group No: </th><td><?Php  echo $GroupNum;?></td>
		 <th>Semester/Year:</th><td><?Php global $semester, $year; echo $semester.'/'.$year;?></td></tr>
		  <tr><th colspan="4">Project title</th><td colspan="2">
		  <?php global $etiltle; echo $etiltle; ?></td><td colspan="2">
		 <?php global $atitle; echo $atitle; ?></td></tr> <tr><th colspan="4">Week No.</th><td colspan="4"><?php global $progress_week; if($progress_week == 1){ echo 'Week 1 – 4 ';}
                              if($progress_week == 2){ echo 'Week 5 – 8 ';}	if($progress_week == 3 || $progress_week ==4){ echo 'Week 9 – 12 ';}		  ?></td>
		 </tr>
		 <tr><th colspan="4">GP Status:</th><td colspan="4"><?php global $progress_week; if($Schdule == 'On'){ echo 'On schedule';}
                              if($Schdule == 'Ahead'){ echo 'Ahead of schedule';}	if($Schdule == 'Behind'){ echo 'Behind schedule';}?></td>
		 </tr></table>
    <!-- modal -->
  ...
  global $sec;
                          ...
                          if($result3 = mysqli_query($connect, $sql3)){
                              if($row4 = mysqli_fetch_array($result3)){
                                 echo '<textarea name="PRsupervisor_rev">'.$row4['supervisor_rev'].'</textarea>'; 
...
?>
 ...
 <?php  
							  ...
							  if($row4['sub_statue'] == 'supervisor'){
?>	
<input type="submit" name="AcceptPR" value="Accept" class = "button1" title = "Submit to Coordinatior">
<input type="submit" name="RejectPR" value="Reject" class = "button2" title = "Resubmit to student"></form>
<?php  
							  }
