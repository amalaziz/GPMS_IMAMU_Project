...
$id = $_GET['id'];
						  $sql4 = "SELECT * FROM student where ID = $id" ;
							  if($result4 = mysqli_query($connect, $sql4))
{    
                        while($row4 = mysqli_fetch_array($result4)){
...
$sql1 = "SELECT * FROM project where Section_No = $section" ;
							  if($result1 = mysqli_query($connect, $sql1))
{    
                        while($row4 = mysqli_fetch_array($result1)){
	$Title  = $row4['Title'];
	$title_arabic = $row4['title_arabic'];
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"id="myP"><?php global $uEmail; echo "<a href='mailto:". $uEmail."'>". $uEmail."</a>"; ?></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <h2 class="m-b-10 f-w-600">Private email</h2>
                                        <h6 class="text-muted f-w-400"id="myP"><?php  global $pEmail; echo "<a href='mailto:". $pEmail."'>". $pEmail."</a>"; ?></h6>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"id="myP"><?php global $Title, $title_arabic; echo $Title.'</br>'.$title_arabic ; ?></h6>
                                    </div>
                                </div>
