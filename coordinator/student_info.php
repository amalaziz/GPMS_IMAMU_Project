...
$sql = "SELECT * FROM student ORDER BY Section_No DESC ";
			...
			?>
              <tr> 
			   <!--FETCHING DATA FROM EACH 
                ...
                <td><?php echo "<a href='mailto:".$row['UEmail']."'>".$row['UEmail']."</a>";?></td>
				<td><?php if($row['coruse_NO'] == 'IS497') {echo 'GP1'; } if($row['coruse_NO'] == 'IS498') {echo 'GP2'; } if($row['coruse_NO'] == 'IS499') {echo 'GP3'; }   ?></td>
				<td><?php echo $row['Group_No'];?></td>
				<td class="wrapper"><a href="moreInfo.php?id=<?php echo$row['ID']; ?>"><span>More..</span></a> </td>
            </tr>
            <?php
                }
             ?>
