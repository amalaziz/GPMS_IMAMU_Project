...
global $cour,  $GroupNum;
	...
	echo("Error description: " . $connect -> error);
			...
			<div class="studiv2"><table border = "1"><tr>
                                      ...
                                      <th>Section Number: </th><td><?php echo $sec; ?></td>
                                      <th>Group No: </th><td><?php echo $GroupNum; ?></td>
                                      <th>Semester/Year:</th><td><?php echo $sem.'/'.$year; ?></td></tr>
    <tr> <form method="post" action="<?php echo '/process.php?id='.$sec ;?>"><th colspan="4">Project title</th><td colspan="4"><?php echo $eTitle; ?></td></tr>
...
<tr><th colspan="10">Coordinator Review:</th></tr>
<tr><td colspan="10" class="sup_rev">
<textarea name="coor_rev"><?php echo $row['coor_review']; ?></textarea>
</td></tr>
  
 </table></div><br> 
 <?php if ($row['status']=='Coordinatior' || $row['status']=='coordinatior' ){ ?>
 <input type="submit" name="coor_acceptdes" value="Accept" class = "button1">
<input type="submit" name="coor_rejectProp" value="Reject" class = "button2" title = "Resubmit to student">
