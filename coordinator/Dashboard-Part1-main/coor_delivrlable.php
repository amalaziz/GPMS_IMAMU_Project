...
<div class ="main">
 ...
 <th class=" thead tit">Group No </th>
 <th class=" thead tit"> Deliverable Name </th>
 <th class=" thead mess"> Last open by </th>
 ...
 <?Php
	...
	$sql1 = "SELECT * FROM first_meeting WHERE Section_No=".$id ; 
                          if($result1 = mysqli_query($connect, $sql1)){
							  while ($row1 = mysqli_fetch_array($result1)){
		
             echo '<tr><td>'.$row1['Section_No'].'</td><td>First metting </td><td> '.$row1['status'].'</td>
			 <td><button class="btn-primary btn"> <a href="Cfirst_metting.php?id='.$row1['Section_No'].'" class="text-white"> view </a> </button></td></tr>';
			break;
    ...
    $sql = "SELECT * FROM description WHERE Section_No= $id" ; 
             ...
             echo '<tr><td>'.$row['Section_No'].'</td><td>Project description</td><td>'.$row['status'].'</td>
			 <td><button class="btn-primary btn"> <a href="coor_description.php?id='.$row['Section_No'].'" class="text-white"> view </a> </button></td></tr>';
			break;
						   ...
						   $sql1 = "SELECT * FROM proposal_summary WHERE Section_No=".$id ; 
                          if($result1 = mysqli_query($connect, $sql1)){
							  while ($row1 = mysqli_fetch_array($result1)){

             echo '<tr><td>'.$row1['Section_No'].'</td><td>GP1 Proposal Summary </td><td>'.$row1['status'].'</td>
			 <td><button class="btn-primary btn"> <a href="coor_proposal.php?id='.$row1['Section_No'].'" class="text-white"> view </a> </button></td></tr>';
			break;
						   ...
						   $sql1 = "SELECT * FROM progress_report WHERE section_number=".$id ; 
                          if($result1 = mysqli_query($connect, $sql1)){
							  while ($row1 = mysqli_fetch_array($result1)){
							 
             echo '<tr><td>'.$row1['section_number'].'</td><td>Progress Report </td><td>'.$row1['sub_statue'].'</td>
			 <td><button class="btn-primary btn"> <a href="coor_progress.php?id='.$row1['section_number'].'" class="text-white"> view </a> </button></td></tr>';
			break;
						   ...
						   $sql1 = "SELECT * FROM finalproject WHERE Section_No=".$id ; 
                          if($result1 = mysqli_query($connect, $sql1)){
							  while ($row1 = mysqli_fetch_array($result1)){
							  
             echo '<tr><td>'.$row1['Section_No'].'</td><td>Final Submissions </td><td>'.$row1['status'].'</td>
			 <td><button class="btn-primary btn"> <a href="uploadt.php?id='.$row1['Section_No'].'" class="text-white"> view </a> </button></td></tr>';
			break;
