	...
	echo("Error description: " . $connect -> error);
		...
		<th>Group No: </th><td><?Php  echo $GroupNum;?></td>
		 <th>Semester/Year:</th><td><?Php  echo $semester.'/'.$year;?></td></tr>
		  <tr> <form method="post" action="<?php echo '/process.php?id='.$id ;?>"><th colspan="4">Project title</th><td colspan="2">
...
<td colspan="2">
<?php if ($row['status']=='Coordinatior' || $row['status']=='coordinatior' ){ echo $row['domain'];} ?>
</td><th colspan="2">Solution Field Of study:</th>
<td colspan="2">
<?php if ($row['status']=='Coordinatior' || $row['status']=='coordinatior' ){ echo $row['solution'];} ?>
</td></tr>
 <tr><th colspan="8">Project Description in English:</th></tr>
		<tr><td colspan="8" class = "texta"><?php if ($row['status']=='Coordinatior' || $row['status']=='coordinatior' ){ echo $row['description_english'];} ?></td></tr>
<tr><th colspan="8">Project Description in Arabic:</th></tr> 
  <tr><td colspan="8" class = "texta"><?php if ($row['status']=='Coordinatior' || $row['status']=='coordinatior' ){  echo $row['description_arabic'];} ?></td></tr>
   
 </table></div><br> 
 <?php if ($row['status']=='Coordinatior' || $row['status']=='coordinatior' ){ ?>

<input type="submit" name="coor_rejectdes" value="Reject" class = "button2" title = "Resubmit to student"></form>
 <?php 
 }		  }
						  }
  ?>
