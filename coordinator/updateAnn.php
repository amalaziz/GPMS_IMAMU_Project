...
if ($connect->connect_error) {
 ...
 $id = $_GET['id'];
 $sql4 = "SELECT * FROM announcement where ID=$id " ;
 ...
 $aText = $_POST['aText'];
  $pdate = $_POST['pdate'];
 $q = " update announcement set ID=$id, title='$aTitle', Message='$aText', User_type = '$newvalues', Date=' $pdate'  where ID=$id  ";
...
<div class="tab">
 ...
 <div class = "post tabcontent card" id = "update" style ="">
 <form method="post">
...
<label for="title"><b>Title</b></label> <br>
 <input type="text" name="aTitle" class="form-control" value = "<?php global $aTit; echo $aTit ;?>"> <br>
<br/>
  <label for="txt"><b>Text</b></label><br>
 <textarea rows="10" cols="30"  name="aText" class="form-control"><?php global $aText; echo $aText ;?></textarea> <br>
<br/>
<label for="pdate"><b>Post date</b></label></br>
 <input type="date" id="pdate" name="pdate">
    ...
    <div id="checkboxes">
	 ...
	 <input class = "cinput" type="checkbox" id="Country" name="Country[]" value="Students">All Students<br/>
	 <hr>
	<?php 
...
{                  	
    ...
    <br/><br/>
            <input id="submit" type="submit" name="done" value="Post" class="subm"> 
</form>
...
function toggle(oInput) {
 ...
 <form action="insertAnn.php" method = "POST">
    ...
    <label for="txt"><b>Text</b></label></br>
    <textarea class ="form-control" rows="10" cols="30" name="aText2" id ="txt" placeholder="Enter Announcements Text" required>
</textarea>
</br>
<label for="pdate"><b>Post date</b></label></br>
 <input type="date" id="pdate" name="pdate">
...
<script>CKEDITOR.replace( 'aText2' ); </script>
</html>